...
def parse_args(parse=True, **optional_kwargs):
    ...
    # Checkpoint
    parser.add_argument('--output', type=str, default='.../your_output_file')
    parser.add_argument('--load', type=str, default='.../Epoch30_base', help='Load the model (usually the fine-tuned model).')
    ...
    parser.add_argument('--unfreeze_layer_norms', type=str2bool, default=True)
    ...
    # PHM linear in adapter
    parser.add_argument('--hypercomplex_division', type=int, default=4)
    parser.add_argument('--phm_rank', type=int, default=4)
    parser.add_argument('--shared_phm_rule', type=str2bool, default=False)
    ...
    parser.add_argument('--add_adapter_self_attn', type=str2bool, default=False)
    ...
    parser.add_argument('--ffn_lora', type=str2bool, default=True)

    # use prompt
    parser.add_argument('--use_prompt', action="store_true")
    parser.add_argument('--pre_seq_len', default=5, type=int)
    parser.add_argument('--prompt_type', type=str, default='hyper_phm_new')  # ap, hyper
    parser.add_argument('--prompt_reduction_factor', default=6, type=int)
    parser.add_argument('--prompt_phm_rank', default=8, type=int)
    parser.add_argument('--prompt_factorized_phm', type=str2bool, default=True)
    parser.add_argument('--prompt_input_type', type=str, default='cls')  # 'cls' 'mean' 'max'
    parser.add_argument('--prompt_cross', type=str2bool, default=False)
    parser.add_argument('--prompt_encoder', type=str2bool, default=True)
    parser.add_argument('--prompt_decoder', type=str2bool, default=True)
    parser.add_argument('--prompt_index_dim', default=2, type=int)
    parser.add_argument('--prompt_hypercomplex_division', default=4, type=int)

    # Inference
    parser.add_argument('--num_beams', type=int, default=5)  # 1
    ...
    parser.add_argument('--dataseed', type=int, default=87, help='random seed')  # 13 21 42 87 100
